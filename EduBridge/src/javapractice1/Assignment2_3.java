...
public class Assignment2_3 
{
	...
	public static void main(String[] args) 
	{
        ...
        System.out.println("Total Marks of First Student:" + total);
        System.out.println("Average Marks of First Student:" + avg);
        
        if(s1Marks1>=35 && s1Marks2>=35 && s1Marks3>=35)
        ...
        System.out.println("Total Marks of Second Student:" + total);
        System.out.println("Average Marks of Second Student:" + avg);
        
        if(s2Marks1>=35 && s2Marks2>=35 && s2Marks3>=35)
        ...
        avg=total/3;
        System.out.println("Total Marks of Third Student:" + total);
        System.out.println("Average Marks of Third Student:" + avg);
        
        if(s3Marks1>=35 && s3Marks2>=35 && s3Marks3>=35)
